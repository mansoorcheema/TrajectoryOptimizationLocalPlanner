...
template <>
void SimulationWorld::setVoxel<TsdfVoxel>(FloatingPoint dist, const Color& color,
...
//// Color ignored.
template <>
void SimulationWorld::setVoxel<EsdfVoxel>(FloatingPoint dist, const Color& color,
